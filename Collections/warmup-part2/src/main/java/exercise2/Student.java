...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if(stud.getId() == this.id
                && stud.getFirstName().equals(((Student) o).getFirstName())
                && stud.getLastName().equals(((Student) o).getLastName())
                && stud.getAverageGrade() == ((Student) o).getAverageGrade() ) return true;
